# -*- coding: utf-8 -*-
"""
Created on Tue Oct 19 22:59:18 2021
...
def get_energy(data):
    ...
    t.append(ae)
    ae=tsf.feature_extraction.feature_calculators.autocorrelation(ts, 6)
    t.append(ae)
    ae=tsf.feature_extraction.feature_calculators.autocorrelation(ts, 4)
    t.append(ae)
    ae=tsf.feature_extraction.feature_calculators.autocorrelation(ts, 3)
    t.append(ae)
    ae=tsf.feature_extraction.feature_calculators.autocorrelation(ts, 2)
    t.append(ae)
    ae=tsf.feature_extraction.feature_calculators.autocorrelation(ts, 1)
    t.append(ae)
